...
//
    ...
    Unicycle myUnicycle=new Unicycle("blue",1,1);
    System.out.println(myUnicycle.getName());
    System.out.println(myUnicycle.getWheels());
    System.out.println(myUnicycle.getSeats());
    myUnicycle.move(10);
    myUnicycle.turn(90);
    myUnicycle.brake(0.10);
    myUnicycle.Spin();
